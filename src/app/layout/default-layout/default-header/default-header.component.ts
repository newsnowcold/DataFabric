...
@Component({
  ...
  imports: [GridModule, HeaderModule, NavModule, IconModule, RouterLink, RouterLinkActive, NgTemplateOutlet, BreadcrumbModule, DropdownModule, AvatarModule, BadgeModule, SidebarModule]
})
