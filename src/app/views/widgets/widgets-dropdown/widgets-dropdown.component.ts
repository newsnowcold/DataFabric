...
@Component({
  ...
  imports: [RowComponent, ColComponent, WidgetStatAComponent, TemplateIdDirective, IconModule, DropdownComponent, ButtonDirective, DropdownToggleDirective, DropdownMenuDirective, DropdownItemDirective, RouterLink, DropdownDividerDirective, ChartjsComponent]
})
